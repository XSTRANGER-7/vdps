...
//       <h1 className="text-3xl font-bold text-center mb-8">Today's Birthdays</h1>
//       {todaysBirthdays.length > 0 ? (
//         <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 px-6">
//           {todaysBirthdays.map((student, index) => (
//             <div
//               key={index}
//               className={`bg-pink-200 border border-gray-300 rounded-lg shadow-lg p-4 relative birthday-card ${
//                 inView ? 'animate-cap' : ''
//               }`}
//             >
//               <img
//                 src={capIcon}
//                 alt="Birthday Cap"
//                 className="birthday-cap w-20 h-20 absolute"
//               />
//                 {student.name}
//               </h2>
