...
//   return (
//     <div ref={containerRef} className="flex flex-col md:flex-row items-center px-20 py-4 my-10 rounded shadow-lg">
//       <img
//         ref={imageRef}
...
//         alt="Director"
//         className="w-96 h-32  border-96 border-purple-600 md:mr-6 mb-4 md:mb-0"
//       />
//       <div className="md:flex-1">
//         <h2 className="text-xl font-bold mb-2">Message from the Director</h2>
//         <p ref={messageRef} className="text-gray-700">
//           Welcome to our school! We are committed to providing an excellent education and fostering a supportive environment.
//           We look forward to a wonderful year of growth and achievement.
//         </p>
//       </div>
//     </div>
//   );
